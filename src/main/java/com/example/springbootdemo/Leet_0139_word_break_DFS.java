 ...
 */
public class Leet_0139_word_break_DFS {
    ...
    public static void main(String[] args) {
        System.out.println(new Leet_0139_word_break_DFS().wordBreak(test1_s, Lists.newArrayList(test1_dict)));
        System.out.println(new Leet_0139_word_break_DFS().wordBreak(test2_s, Lists.newArrayList(test2_dict)));
